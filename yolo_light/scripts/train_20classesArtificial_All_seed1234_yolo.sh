...
FolderRoot="/root/share/mountplace/20classesArtificial_All/"
seed=1234
...
python3 ./flow_ARC2017Settings --train \
                        ...
                        --load "/root/share/mountplace/weights/yolo-full.weights" \
                        ...
                        --test $FolderRoot"data/images-outputTest-Full/" \
