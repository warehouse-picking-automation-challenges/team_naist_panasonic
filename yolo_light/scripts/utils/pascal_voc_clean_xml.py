...
def pascal_voc_clean_xml(ANN, pick, exclusive = False, showinfo=True):
	if showinfo is True: print(sys.version)
	if showinfo is True: print('Parsing for {} {}'.format(
	...
	if showinfo is True: print('Statistics:')
	if showinfo is True: pp(stat)
	if showinfo is True: print('Dataset size: {}'.format(len(dumps)))
