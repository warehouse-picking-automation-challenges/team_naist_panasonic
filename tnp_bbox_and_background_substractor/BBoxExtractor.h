...
public:
    ...
    cv::Mat generateView(const RgbdFrame &frame, const std::vector<cv::Point3f>& recoBBOX, const std::vector<cv::Point3f>& OBB, const std::vector<cv::Point3f>& AABB, const std::vector<std::vector<cv::Point3f> >& qrCodePoints = std::vector<std::vector<cv::Point3f> >());
