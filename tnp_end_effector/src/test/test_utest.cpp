 ...
 */
class TnpEndEffectorNodeTest : public ::testing::Test
{
...
protected:
  ...
  EndEffectorNode instance;
  double a;

  TnpEndEffectorNodeTest()
  {
    a = 42;
    // You can do set-up work for each test here.
  }

  virtual ~TnpEndEffectorNodeTest()
  {
 ...
 * Tests that the tnpTaskManager::testMethod() method does on negative values.
 */
TEST_F(TnpEndEffectorNodeTest, testMethodOnNegativeValues)
{
  EXPECT_EQ(false, false);
}
 ...
 */
TEST_F(TnpEndEffectorNodeTest, testMethodTestUnevenValues)
{
  EXPECT_EQ(false, false);
}
 ...
 */
TEST_F(TnpEndEffectorNodeTest, testOnEqualNUmbers)
{
  EXPECT_EQ(true, true);
}
