...
#include "iiwa_ros/iiwa_ros.h"           // To call time_to_destination
#include <chrono>
...
public:
  ...
  bool goToBinCallback(tnp_kuka_motion::goToBin::Request &req,
                          tnp_kuka_motion::goToBin::Response &res);
  bool goToBoxCallback(tnp_kuka_motion::goToBox::Request &req,
                          tnp_kuka_motion::goToBox::Response &res);
...
{ 
  ...
  goToRecSpaceService = n_.advertiseService("tnp_kuka_motion/goToRecSpace", &SubscribeAndPublish::goToRecSpaceCallback,
                                        this);
  goToBinService = n_.advertiseService("tnp_kuka_motion/goToBin", &SubscribeAndPublish::goToBinCallback,
                                        this);
  goToBoxService = n_.advertiseService("tnp_kuka_motion/goToBox", &SubscribeAndPublish::goToBoxCallback,
                                        this);
...
bool SubscribeAndPublish::goToBinCallback(tnp_kuka_motion::goToBin::Request &req,
                              tnp_kuka_motion::goToBin::Response &res)
{
...
bool SubscribeAndPublish::goToBoxCallback(tnp_kuka_motion::goToBox::Request &req,
                              tnp_kuka_motion::goToBox::Response &res)
{
