...
# python augmentation.py /root/share/tnp_svm rectified_amazon_bgr augmented_pick

#### augment own 10items
python augmentation.py /root/share/tnp_svm rectified_own_bgr augmented_pick

cd /root/share/tnp_svm/augmented_pick

cp -r * /root/share/tnp_svm/for_training_pick

cd /root/catkin_ws/src/tnp/tnp_svm/script

#### train all 20items data Stow Task
python HOG_SVM_training.py /root/share/tnp_svm for_training_pick hog_svm_pick.pkl
# #### train all 32items data Pick Task
# python HOG_SVM_training.py /root/share/tnp_svm augmented_32items hog_svm_pick.pkl
