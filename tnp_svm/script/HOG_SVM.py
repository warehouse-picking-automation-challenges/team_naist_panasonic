...
data_dir_path = "/root/catkin_ws/src/tnp/tnp_svm/script/realdata"
group_name = "augmented_32items"
...
def LoadFile(filename, rgb_image_path):
	label = rgb_image_path.replace(data_dir_path +  '/' + group_name + '/','')
	label = label.lower()        
...
def Matching():
	...
	joblib.dump(svm_best, '32items.pkl', compress=9)

	##############cross validation
	scores = cross_validation.cross_val_score(svm_best, des, labels, cv=10)
